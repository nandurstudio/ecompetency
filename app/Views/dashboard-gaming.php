...
<head>
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon" sizes="57x57" href="assets/bame/assets/img/favicons/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="assets/bame/assets/img/favicons/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="assets/bame/assets/img/favicons/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="assets/bame/assets/img/favicons/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="assets/bame/assets/img/favicons/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="assets/bame/assets/img/favicons/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="assets/bame/assets/img/favicons/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="assets/bame/assets/img/favicons/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="assets/bame/assets/img/favicons/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192" href="assets/bame/assets/img/favicons/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assets/bame/assets/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="assets/bame/assets/img/favicons/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assets/bame/assets/img/favicons/favicon-16x16.png">
    <link rel="manifest" href="assets/bame/assets/img/favicons/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="assets/bame/assets/img/favicons/ms-icon-144x144.png">
    ...
    <!-- All CSS File -->
    <!-- Bootstrap -->
    <link rel="stylesheet" href="<?= base_url('assets/bame/assets/css/bootstrap.min.css'); ?>">
    <!-- Fontawesome Icon -->
    <link rel="stylesheet" href="<?= base_url('assets/bame/assets/css/fontawesome.min.css'); ?>">
    <!-- Magnific Popup -->
    <link rel="stylesheet" href="<?= base_url('assets/bame/assets/css/magnific-popup.min.css'); ?>">
    <!-- Swiper Js -->
    <link rel="stylesheet" href="<?= base_url('assets/bame/assets/css/swiper-bundle.min.css'); ?>">
    <!-- Theme Custom CSS -->
    <link rel="stylesheet" href="<?= base_url('assets/bame/assets/css/style.css'); ?>">
            ...
            <div class="widget footer-widget">
                <div class="th-widget-about">
                    <div class="about-logo">
                        <a href="/">
                            <span data-mask-src="assets/bame/assets/img/logo.svg" class="logo-mask"></span>
                            <img src="assets/bame/assets/img/logo.svg" alt="Bame">
                        </a>
                    </div>
                    ...
                    <div class="th-widget-contact">
                        <div class="th-social style-mask">
                            ...
                            <a class="twitter" href="https://www.twitter.com/"><img src="assets/bame/assets/img/icon/x-twitter-icon.svg" alt="icon"></a>
                            <a class="instagram" href="https://www.instagram.com/">
                                <img src="assets/bame/assets/img/icon/instagram-icon.svg" alt="icon">
                            </a>
                            <a class="linkedin" href="https://www.linkedin.com/"><i class="fab fa-linkedin"></i></a>
                            <a class="google-play" href="https://www.google.com/">
                                <img src="assets/bame/assets/img/icon/google-playstore-icon.svg" alt="icon">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="widget  ">
                ...
                <div class="recent-post-wrap">
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details.html"><img src="assets/bame/assets/img/blog/recent-post-1-1.jpg" alt="Blog Image"></a>
                        </div>
                    ...
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details.html"><img src="assets/bame/assets/img/blog/recent-post-1-2.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details.html"><img src="assets/bame/assets/img/blog/recent-post-1-3.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="media-body">
    ...
    <div class="th-menu-wrapper">
        <div class="th-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="index.html"><span data-mask-src="assets/bame/assets/img/logo.svg" class="logo-mask"></span><img src="assets/bame/assets/img/logo.svg" alt="Bame"></a>
            </div>
                    ...
                    <div class="row g-0 align-items-center">
                        <div class="col-auto me-auto">
                            <div class="header-logo">
                                <a href="index.html">
                                    <span data-mask-src="assets/bame/assets/img/logo-icon.svg" class="logo-mask"></span>
                                    <img src="assets/bame/assets/img/logo-icon.svg" alt="Bame">
                                </a>
                            </div>
                        </div>
                        <div class="col-auto me-auto">
...
Hero Area
==============================-->
    <div class="th-hero-wrapper hero-5 bg-black" id="hero" data-bg-src="assets/bame/assets/img/hero/hero-4-bg.png">
        <div class="hero-bg-text">Gamer</div>
        <div class="container">
            <div class="row align-items-center flex-row-reverse">
                <div class="col-lg-6">
                    <div class="hero-thumb5-1">
                        <img src="assets/bame/assets/img/hero/hero-5-1.png" alt="img">
                    </div>
                </div>
                <div class="col-lg-6">
...
Client Area  
==============================-->
    <div class="client-area-3 overflow-hidden " data-bg-src="assets/bame/assets/img/bg/client3-bg-shape.png">
        <div class="container-fluid p-0">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <a href="#" class="client-card2">
                            <img src="assets/bame/assets/img/client/1-1.png" alt="Image">
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="client-card2">
                            <img src="assets/bame/assets/img/client/1-2.png" alt="Image">
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="client-card2">
                            <img src="assets/bame/assets/img/client/1-3.png" alt="Image">
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="client-card2">
                            <img src="assets/bame/assets/img/client/1-4.png" alt="Image">
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="client-card2">
                            <img src="assets/bame/assets/img/client/1-6.png" alt="Image">
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="client-card2">
                            <img src="assets/bame/assets/img/client/1-7.png" alt="Image">
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="client-card2">
                            <img src="assets/bame/assets/img/client/1-8.png" alt="Image">
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="client-card2">
                            <img src="assets/bame/assets/img/client/1-9.png" alt="Image">
                    ...
                    <div class="title-area text-center custom-anim-top wow" data-wow-duration="1.5s" data-wow-delay="0.1s">
                        <span class="sub-title style3">
                            <span class="sub-title-shape icon-masking">
                                <span class="mask-icon" data-mask-src="assets/bame/assets/img/bg/section-title-bg.svg"></span>
                            </span>
                ...
                <div class="col-12">
                    <div class="img-box5 mb-60">
                        <div class="custom-anim-top wow" data-wow-duration="1.5s" data-wow-delay="0.2s">
                            <img class src="assets/bame/assets/img/normal/about5-1.png" alt="About">
                        </div>
                    </div>
                </div>
            </div>
...
Experience Area  
==============================-->
    <div class="overflow-hidden space" id="experience-sec" data-bg-src="assets/bame/assets/img/bg/experience-sec1-bg.png">
        <div class="container">
                ...
                <div class="col-xl-6">
                    <div class="experience-thumb ms-xxl-5">
                        <div class="custom-anim-right wow" data-wow-duration="1.5s" data-wow-delay="0.2s">
                            <img class src="assets/bame/assets/img/normal/experience1-1.png" alt="img">
                        </div>
                    </div>
                </div>
                <div class="col-xl-5">
                    ...
                    <div class="swiper-wrapper">
                        <div class="col-lg-3 swiper-slide">
                            <div class="video-box4">
                                <img src="assets/bame/assets/img/video/5-1.png" alt="img">
                        ...
                        <div class="col-lg-3 swiper-slide">
                            <div class="video-box4">
                                <img src="assets/bame/assets/img/video/5-2.png" alt="img">
                                <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="play-btn style4 popup-video"><i class="fa-sharp fa-solid fa-play"></i></a>
                                <div class="video-tab-btn filter-menu-cat-active">
                                    <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="popup-video">Twitch</a>
                                    <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="popup-video">YouTube</a>
                        ...
                        <div class="col-lg-3 swiper-slide">
                            <div class="video-box4">
                                <img src="assets/bame/assets/img/video/5-3.png" alt="img">
                                <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="play-btn style4 popup-video"><i class="fa-sharp fa-solid fa-play"></i></a>
                                <div class="video-tab-btn filter-menu-cat-active">
                                    <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="popup-video">Twitch</a>
                                    <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="popup-video">YouTube</a>
                        ...
                        <div class="col-lg-3 swiper-slide">
                            <div class="video-box4">
                                <img src="assets/bame/assets/img/video/5-4.png" alt="img">
                                <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="play-btn style4 popup-video"><i class="fa-sharp fa-solid fa-play"></i></a>
                                <div class="video-tab-btn filter-menu-cat-active">
                                    <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="popup-video">Twitch</a>
                                    <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="popup-video">YouTube</a>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="blog-card style5">
                                <div class="blog-img" data-mask-src="assets/bame/assets/img/blog/blog_card5_img-shape.jpg">
                                    <a href="blog-details.html">
                                        <img src="assets/bame/assets/img/blog/blog_5_1.jpg" alt="blog image">
                                    </a>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-card style5">
                                <div class="blog-img" data-mask-src="assets/bame/assets/img/blog/blog_card5_img-shape.jpg">
                                    <a href="blog-details.html">
                                        <img src="assets/bame/assets/img/blog/blog_5_2.jpg" alt="blog image">
                                    </a>
                                </div>
                                <div class="blog-content">
                                    <div class="blog-meta">
                        ...
                        <div class="swiper-slide">
                            <div class="blog-card style5">
                                <div class="blog-img" data-mask-src="assets/bame/assets/img/blog/blog_card5_img-shape.jpg">
                                    <a href="blog-details.html">
                                        <img src="assets/bame/assets/img/blog/blog_5_3.jpg" alt="blog image">
                                    </a>
                                </div>
                                <div class="blog-content">
                                    <div class="blog-meta">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <a href="#" class="brand-box style2">
                            <div class="brand-box-shape" data-bg-src="assets/bame/assets/img/brand/brand_2_bg.png"></div>
                            <div class="brand-box-shape2" data-bg-src="assets/bame/assets/img/brand/brand_2_1_bg.png"></div>
                            <img src="assets/bame/assets/img/brand/brand_2_1.png" alt="Brand Logo">
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="#" class="brand-box style2">
                            <div class="brand-box-shape" data-bg-src="assets/bame/assets/img/brand/brand_2_bg.png"></div>
                            <div class="brand-box-shape2" data-bg-src="assets/bame/assets/img/brand/brand_2_1_bg.png"></div>
                            <img src="assets/bame/assets/img/brand/brand_2_2.png" alt="Brand Logo">
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="#" class="brand-box style2">
                            <div class="brand-box-shape" data-bg-src="assets/bame/assets/img/brand/brand_2_bg.png"></div>
                            <div class="brand-box-shape2" data-bg-src="assets/bame/assets/img/brand/brand_2_1_bg.png"></div>
                            <img src="assets/bame/assets/img/brand/brand_2_3.png" alt="Brand Logo">
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="#" class="brand-box style2">
                            <div class="brand-box-shape" data-bg-src="assets/bame/assets/img/brand/brand_2_bg.png"></div>
                            <div class="brand-box-shape2" data-bg-src="assets/bame/assets/img/brand/brand_2_1_bg.png"></div>
                            <img src="assets/bame/assets/img/brand/brand_2_4.png" alt="Brand Logo">
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="#" class="brand-box style2">
                            <div class="brand-box-shape" data-bg-src="assets/bame/assets/img/brand/brand_2_bg.png"></div>
                            <div class="brand-box-shape2" data-bg-src="assets/bame/assets/img/brand/brand_2_1_bg.png"></div>
                            <img src="assets/bame/assets/img/brand/brand_2_5.png" alt="Brand Logo">
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="#" class="brand-box style2">
...
============================== -->
    <!-- Jquery -->
    <script src="assets/bame/assets/js/vendor/jquery-3.7.1.min.js"></script>
    <!-- Swiper Js -->
    <script src="assets/bame/assets/js/swiper-bundle.min.js"></script>
    <!-- Bootstrap -->
    <script src="assets/bame/assets/js/bootstrap.min.js"></script>
    <!-- Magnific Popup -->
    <script src="assets/bame/assets/js/jquery.magnific-popup.min.js"></script>
    <!-- Counter Up -->
    <script src="assets/bame/assets/js/jquery.counterup.min.js"></script>
    <!-- Range Slider -->
    <script src="assets/bame/assets/js/jquery-ui.min.js"></script>
    <!-- Isotope Filter -->
    <script src="assets/bame/assets/js/imagesloaded.pkgd.min.js"></script>
    <script src="assets/bame/assets/js/isotope.pkgd.min.js"></script>
    <!-- gsap -->
    <script src="assets/bame/assets/js/gsap.min.js"></script>

    <script src="assets/bame/assets/js/waypoints.js"></script>
    <script src="assets/bame/assets/js/wow.js"></script>
    <script src="assets/bame/assets/js/smooth-scroll.js"></script>

    <!-- Main Js File -->
    <script src="assets/bame/assets/js/main.js"></script>
</body>
